...
const faqItems: FAQItem[] = [
  ...
  {
    id: "hotkeys",
    question: "Какие горячие клавиши работают во время игры?",
    answer:
      "Во время игры (при фокусе не в поле ввода) действуют клавиши: Q или Й — «Мои характеристики» / «Мои слова»; W или Ц — «Спец. карты» (только режим «Бункер», фаза игры или голосования); E или У — информация о бункере (только режим «Бункер»); R или К — «Управление» характеристиками (только ведущий); T или Е — открыть/закрыть чат; B или И — показать/скрыть нижнюю панель с кнопками; N или Т — показать/скрыть верхнюю панель (шапка и баннер катастрофы); Y или Н — панель эффектов «Дразнить» на камеру (для премиум). Раскладка учтена: одна и та же физическая клавиша работает и в латинице, и в кириллице.",
    category: "gameplay",
  },
  // Технические вопросы
  {
