...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Нет. Достижения начисляются только за игры в режиме «Бункер». В режиме «Кто Я?» статистика игр и достижения игрокам не выдаются.",
    category: "gameplay",
  },
  // Технические вопросы
  {
  ...
  // Подписки
  {
    ...
    answer:
      "Базовый тариф: до 3 комнат в день, до 12 игроков в комнате. Премиум тариф: неограниченное создание комнат, до 20 игроков в комнате, создание кастомных характеристик, сохранение шаблонов игр, экспорт результатов, приоритетная поддержка.",
